  ...
  render() {
    return (
      <div className='container'> 
        ...
        <p Style={'text-align:left;'}>Bugs can cause core functions of any application/product to malfunction and cost companies valuable time and money. They can occur for various reasons. From my personal experience and research I know that bugs can occur when</p>
